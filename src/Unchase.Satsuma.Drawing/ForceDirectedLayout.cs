...
{
	/// <inheritdoc cref="ForceDirectedLayout{TNodeProperty, TArcProperty}"/>
	public sealed class ForceDirectedLayout :
        ForceDirectedLayout<object, object>
    {
		/// <summary>
	...
	public class ForceDirectedLayout<TNodeProperty, TArcProperty>
	{
        /// <summary>
